            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" id="formulario" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="is_admin" class="col-md-4 col-form-label text-md-right">{{ __('Seleccione el rol') }}</label>
                            <div class="col-md-6">
                                <!-- <input id="is_admin" type="checkbox" class="form-control @error('is_admin') is-invalid @enderror" name="is_admin" value="{{ old('is_admin') }}" indeterminate > -->
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="button" id="boton" name="boton" class="btn btn-primary">
                                    {{ __('Registrar') }}
                                </button>
                            </div>
                        </div>
...
<script src="{{ asset('js/checkUser.js') }}"></script>