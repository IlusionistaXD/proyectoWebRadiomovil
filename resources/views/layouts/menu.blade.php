		...
		<div class="navbar-wrapper ">
			<div class="navbar-content scroll-div" >
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item">
					    <a href="{{ route('welcome_admin') }}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Pagina Bienvenida</span></a>
					</li>
					...
					<li class="nav-item pcoded-hasmenu">
					    ...
					    <ul class="pcoded-submenu">
							...
							<li><a href="{{ route('viajesadmin') }}" class="ml-4 text-sm text-gray-700 underline">Viajes</a></li>
					    </ul>
					</li>
					<li class="nav-item pcoded-hasmenu">
                        <a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-layout"></i></span><span class="pcoded-mtext">Gestion</span></a>
					    <ul class="pcoded-submenu">
					        <li><a href="{{ route('nuevoreporte') }}" class="ml-4 text-sm text-gray-700 underline">Reportes</a></li>
					        <li><a href="{{ route('estadistica') }}" class="ml-4 text-sm text-gray-700 underline">Estadisticas</a></li>
					    </ul>
								...
								<div class="col-lg-12">
									<div class="row">
										...
										<div class="col-lg-4 col-md-4 col-sm-12 p-0">
											<button type="button" id="boton_busqueda" name ="boton_busqueda" class="btn btn-danger wrn-btn">Buscar</button>
										</div>
									</div>
